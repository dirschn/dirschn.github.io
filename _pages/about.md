...
I am the lead developer here for a project called Silenthium, which is a covert communications solution. This project has helped me
learn much about JavaScript through the use of the Node backend and React frontend. I have also worked with web apps with a Python backend, and continued my PHP journey with some custom Moodle plugins for our use.
